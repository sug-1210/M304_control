...
def get_mem_data(data):
    ...
    while(True):
        ...
        data_1 = Block_B(valid[0], int(room[0], 16), int(region[0], 16), int(order[1]+order[0], 16), int(priority[0], 16), int(lv[0], 16), int(cast[0], 16), chr(int(sr[0], 16)), ccm_tmp, unit_tmp, int(sthr[0], 16), int(stmn[0], 16), int(edhr[0], 16), int(edmn[0], 16), int(inmn[0], 16), int(dumn[0], 16), int(rly_l[0], 16), int(rly_h[0], 16), alignment[0], dummy_tmp)
        return data_1
        break
